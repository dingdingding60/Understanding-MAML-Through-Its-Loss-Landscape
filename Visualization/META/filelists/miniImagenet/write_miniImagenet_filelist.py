...
cwd = os.getcwd() 
data_path = '/root/autodl-tmp/mini'
savedir = './'
dataset_list = ['base', 'val', 'novel',"task"]
dataset_list = ["task"]
...
datasetmap = {'base':'train','val':'val','novel':'test',"task":"task"};
filelists = {'base':{},'val':{},'novel':{},'task':{} }
filelists_flat = {'base':[],'val':[],'novel':[],'task':[] }
labellists_flat = {'base':[],'val':[],'novel':[],'task':[]}
...
for dataset in dataset_list:
    with open(datasetmap[dataset] + ".csv", "r") as lines:
        ...
        for i, line in enumerate(lines):
            ...
            if count ==600:
                count=0
            fname = join( data_path,label, sorted_fnames[count] )
