...
class MetaTemplate(nn.Module):
    ...
    def correct(self, x,args):       
        scores,query_loss,set_loss = self.set_forward(x,args)
        if args.losstype=="query":
            ...
            return float(top1_correct), len(y_query),query_loss,set_loss
        else:
            return 0, 1,query_loss,set_loss
