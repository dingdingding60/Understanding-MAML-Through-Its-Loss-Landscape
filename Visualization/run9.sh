CUDA_VISIBLE_DEVICES=0 python plot_surface.py --cuda --plot --model Conv6 \
--model_file /root/autodl-tmp/checkpoints/miniImagenet/Conv6_maml_approx_5way_1shot_seed5/best_model.tar \
...
CUDA_VISIBLE_DEVICES=0 python plot_surface.py --cuda --plot --model Conv6 \
--model_file /root/autodl-tmp/checkpoints/CUB/Conv6_maml_approx_5way_1shot_seed5/best_model.tar \
